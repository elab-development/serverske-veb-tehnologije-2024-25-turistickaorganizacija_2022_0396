                        ...
                        <div class="card-body">
                            <form action="{{ route('admin_setting_update',$setting->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Trenutni logo</label>
                                            <div><img src="{{ asset('uploads/'.$setting->logo) }}" alt="" class="w_200"></div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Promeni logo</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Trenutni baner</label>
