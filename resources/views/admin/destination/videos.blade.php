...
<div class="main-content">
    <section class="section">
        <div class="section-header justify-content-between">
            <h1>Video snimci {{ $destination->name }}</h1>
            <div class="ml-auto">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin_destination_video_delete',$item->id) }}" class="btn btn-danger btn-sm" onClick="return confirm('Da li ste sigurni?')">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
